  ...
  return (
    <main className="bg-secondary h-full w-full md:h-auto lg:max-w-4xl">
      ...
      <section className="flex h-[calc(100%-48px)] flex-col gap-4 overflow-auto p-4 md:flex-row">
        ...
        <div className="bg-content h-full w-full p-4">
          <h2 className="text-3xl">Ola, eu sou Gustavo</h2>
          ...
          <h3 className="text-focus font-segoe-bold">Alguns fatos</h3>
          <ul className="m-2">
          ...
          <h3 className="text-focus font-segoe-bold">Alguns curiosidades</h3>
          <ul className="m-2">
            <li>sou vascaino</li>
            <li>sou vascaino</li>
          </ul>
